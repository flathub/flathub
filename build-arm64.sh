...
#===============================================================================
# Disgaea DS Manager - ARM64 Flatpak Build Script
# Builds, bundles, and optionally installs the ARM64 version
#===============================================================================

# Configuration
readonly APP_ID="app.vercel.landonsoft.DisgaeaDSManager"
readonly MANIFEST="app.vercel.landonsoft.DisgaeaDSManager.arm64.yml"
readonly BUILD_DIR="build-dir-arm64"
readonly REPO_DIR="repo-arm64"
readonly BUNDLE_NAME="DisgaeaDSManager-arm64.flatpak"
...
build_flatpak() {
    log_info "Building Flatpak application for ARM64 architecture..."
...
main() {
    echo ""
    echo "════════════════════════════════════════════════════════════"
    log_info "Disgaea DS Manager - ARM64 Flatpak Builder"
    echo "════════════════════════════════════════════════════════════"
    echo ""
