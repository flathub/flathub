...
sed -n '1,60p' spyder_deps_1.txt > spyder_deps_1_temp.txt  # Save the first 60 lines of fileA to a temporary file
sed -n '61,$p' spyder_deps_1.txt > spyder_deps_2.txt      # Save lines 61 and beyond to fileB
mv spyder_deps_1_temp.txt spyder_deps_1.txt               # Overwrite fileA with the first 60 lines from the temporary file
