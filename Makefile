...
help:
	...
	@echo "  check-version  - Check for available updates using Python script"
	@echo "  update-version - Update using Python update script"
...
# Check for updates using Python script
.PHONY: check-version
check-version:
	@echo "Checking for BrowserOS updates using Python script..."
	@$(MAKE) update-version

# Update using Python script
.PHONY: update-version
update-version:
	@echo "Updating BrowserOS using Python update script..."
	@if [ -f "update_browseros.py" ]; then \
		python update_browseros.py; \
	else \
		echo "Error: update_browseros.py not found"; \
		exit 1; \
	fi
...
show-version:
	...
	@echo "Run 'make check-version' to see current version and available updates"
	@echo "Run 'make update-version' to update to latest version"
