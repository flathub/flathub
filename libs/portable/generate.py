...
def write_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("hoptodesk".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../hoptodesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\hoptodesk\flutter\build\windows\runner\Debug\ -o . -e ..\hoptodesk\flutter\build\windows\runner\Debug\hoptodesk.exe
