...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
		...
		("outgoing_only_desk_tip", "To jest spersonalizowana edycja. Możesz łączyć się z innymi urządzeniami, ale inne urządzenia nie mogą połączyć się z twoim urządzeniem."),
		("preset_password_warning", "Ta spersonalizowana edycja jest wyposażona we wstępnie ustawione hasło. Każdy, kto zna to hasło, może uzyskać pełną kontrolę nad twoim urządzeniem. Jeśli się tego nie spodziewałeś, natychmiast odinstaluj oprogramowanie."),
		...
		("default_proxy_tip", "Domyślny proxy"),
		("no_audio_input_device_tip", "Brak urządzenia wejściowego audio"),
		("Incoming", "Przychodzące"),
		("Outgoing", "Wychodzące"),
		("Clear Wayland screen selection", "Wyczyść wybór ekranu Wayland"),
		("clear_Wayland_screen_selection_tip", "Usuń wybór ekranu Wayland"),
		("confirm_clear_Wayland_screen_selection_tip", "Potwierdź usunięcie wyboru ekranu Wayland"),
		("android_new_voice_call_tip", "Nowa rozmowa głosowa na Androidzie"),
		("texture_render_tip", "Wskazówka dotycząca renderowania tekstur"),
		("Use texture rendering", "Użyj renderowania tekstur"),
		("Floating window", "Pływające okno"),
		("floating_window_tip", "Porada dotycząca pływającego okna"),
		("Keep screen on", "Utrzymuj ekran włączony"),
		("Never", "Nigdy"),
		("During controlled", "Podczas kontrolowania"),
		("During service is on", "Podczas działania usługi"),
		("Capture screen using DirectX", "Przechwytywanie ekranu za pomocą DirectX"),
		("Back", "Wstecz"),
		("Apps", "Aplikacje"),
		...
		("enable-bot-tip", "Włącz wskazówkę bota"),
		("enable-bot-desc", "Opis włączenia bota"),
		("cancel-2fa-confirm-tip", "Anuluj potwierdzenie 2FA"),
		("cancel-bot-confirm-tip", "Anuluj potwierdzenie bota"),
